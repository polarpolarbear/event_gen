...
#parser.add_argument('--ckpt', type=str, default='./logs_ae/airplane/ckpt_0.000193_109000.pt')
#parser.add_argument('--categories', type=str_list, default=['airplane'])


parser.add_argument('--categories', type=str_list, default=['all'])
parser.add_argument('--ckpt', type=str, default='./logs_ae/all/ckpt_0.000620_134000.pt')
